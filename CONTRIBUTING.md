# Contributing to LLM Guard Lab

Welcome and thank you for your interest in contributing to LLM Guard Lab! We appreciate all contributions, big or small, from bug fixes to new features. Before diving in, let's go through some guidelines to make the process smoother for everyone.
...
1. Clone the repository: `git clone https://github.com/sudheervadlamudi1/llm-guard-lab.git`
2. Enter the project directory: `cd llm-guard-lab`
